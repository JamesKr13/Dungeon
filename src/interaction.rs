        ...
        Self {
            rules: HashMap::from([
                (
                    "S".to_string(),
                    vec![
                        "The MV Type of Pl U".to_string(),
                        "A MV Type of Adj , U".to_string(),
                        "The Type of Pl , U".to_string(),
                        "A Type fit for N the Adj , U who was the P as Leader of Pl King of Pl"
                            .to_string(),
                    ],
                ),
                (
                    "U".to_string(),
                    vec![
                        "weilded by N to V the Adj N".to_string(),
                        "used to V N at the Nu of Pl to V N of Pl".to_string(),
                        "given to the MV N on the eve of the Pl day by N leader Pl and R to N"
                            .to_string(),
                    ],
                ),
                (
                    "Pl".to_string(),
                    vec![
                        "Moose Yarmtoon, land of Adj".to_string(),
                        "Port Welchbaw".to_string(),
                        "Rooplains".to_string(),
                        "West Bol".to_string(),
                        "Oakquet".to_string(),
                        "Branwo Hills".to_string(),
                        "East-West Kenwick".to_string(),
                        "Sense Springs".to_string(),
                        "Chamkam Ferry".to_string(),
                        "New Mutthag".to_string(),
                    ],
                ),
                (
                    "V".to_string(),
                    vec![
                        "ask Pl the V".to_string(),
                        "removed".to_string(),
                        "play with".to_string(),
                        "decimate".to_string(),
                        "pack away".to_string(),
                ...
                (
                    ...
                    vec![
                        "LN".to_string(),
                        "T MN LN".to_string(),
                        "T MN MN MN LN the Adj".to_string(),
                        "T MN MN LN of Pl ,who P to N".to_string(),
                        "MN MN LN the RN".to_string(),
                    ],
                ),
                (
                    "MN".to_string(),
                ...
                (
                    ...
                    vec![
                        ...
                        "mythical".to_string(),
                        "storied".to_string(),
                        "allegorical".to_string(),
                        "apocryphal".to_string(),
                        "created".to_string(),
                        "customary".to_string(),
                        "doubtful".to_string(),
                        "dubious".to_string(),
                        ...
                        "fanciful".to_string(),
                        "figmental".to_string(),
                        "handed-down".to_string(),
                        "imaginary".to_string(),
                        "imaginative".to_string(),
                        "improbable".to_string(),
                        "invented".to_string(),
                ...
                (
                    ...
                    vec![
                        ...
                        "approved".to_string(),
                        "cheered".to_string(),
                        "commendated".to_string(),
                        "complimented".to_string(),
                        "cried".to_string(),
                        "devoted themselves".to_string(),
                        "held in high esteem".to_string(),
                        "glorified".to_string(),
                        "gave kudos".to_string(),
                        "welcomed".to_string(),
                        "plaudit".to_string(),
                        "raved about".to_string(),
                        "kneeled before".to_string(),
                        "hailed".to_string(),
                        "thanked".to_string(),
                        "payed tribute to".to_string(),
                    ],
                ),
                (
                    "T".to_string(),
                    vec![
                        ...
                        "Butcher".to_string(),
                        "Criminal".to_string(),
                        "The V King".to_string(),
                        "Slaughter of Pl,".to_string(),
                    ],
                ),
            ]),
        }
